...
public class TokenJWT {
    ...
    public static String createToken(User user) throws Exception{
        ...
        nowTime.add(Calendar.MINUTE,12000);
    ...
    public static String createToken(Map<String, Object> payload) {
        ...
        // 创建一个 JWS object
        JWSObject jwsObject = new JWSObject(header, new com.nimbusds.jose.Payload(new JSONObject(payload)));
        try {
            // 将jwsObject 进行HMAC签名

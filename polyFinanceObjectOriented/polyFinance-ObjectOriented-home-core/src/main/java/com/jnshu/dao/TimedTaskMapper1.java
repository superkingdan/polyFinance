...
public interface TimedTaskMapper1 {
    ...
    Integer deleteOldTransReturn(long transactionId);
    ...
    Integer updateOldTransByTransId(TimedTask timedTask);
    ...
    Integer addTaskedTime(TimedTask timedTask);
    ...
    Integer updateTaskTimeByClaimsId(TimedTask timedTask);
}
